 <?php
	...
	$query = "SELECT * FROM penjualan WHERE idpelanggan = '$idpel'  ORDER BY idpenjualan  DESC LIMIT 1";
	
	//echo $query;
	$exc = mysql_query($query) or die(mysql_error());
	$hasil = mysql_fetch_array($exc) or die(mysql_error());
	$kode_unik = $hasil['kode_unik']; //dapatkan kode_unik
	$hartot = $hasil['total_harga'];
						...
						<div class="col-md-8">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h2>Silahkan kirim ke rekening BRI 1234568999999</h2>
								</div>
								<div class="panel-body">
									<p class="pp"> 
										<br/>Dengan kode konfirmasi <?php echo $kode_unik?>
										<br/>Dengan total harga <?php echo $hartot?>
										<br/>Terima Kasih
									</p>
								</div>
							</div>
